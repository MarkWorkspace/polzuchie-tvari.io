...
const FIELD_LABELS: Record<string, string> = {
  ...
  portals_teleport_delay_ms: "Teleport Delay (ms)",
  portals_spawn_chance: "Portal Spawn Chance",
  portals_growth_time: "Portal Growth/Shrink Time",
...
const FIELD_TOOLTIPS: Record<string, string> = {
  ...
  portals_teleport_delay_ms: "Delay in milliseconds before the snake emerges from the output portal after entering the input portal.",
  portals_spawn_chance: "Probability (0 to 1) checked once per minute for each slot to determine if a portal should grow.",
  portals_growth_time: "Duration in seconds for a portal to smoothly grow or collapse between zero and its full size.",
