...
const translations = {
  ...
  "help.cameraSwitch": { ru: "Смена камеры (2D / 3D)", en: "Camera switch (2D / 3D)" },
  ...
  "status.kbdGuide": { ru: "A/D/Стрелочки — рулить | Пробел — ускорение | C — камера | T — управление", en: "A/D/Arrows — steer | Space — boost | C — camera | T — controls" },
  "status.mouseGuide": { ru: "Движение за курсором | Пробел — ускорение | C — камера | T — управление", en: "Move with cursor | Space — boost | C — camera | T — controls" },
